...
var gameState = {
  preload: function() {
    // 加载各种图像资源
    game.load.spritesheet('bird', '/static/app01/images/bird.png', 92, 64);
    game.load.image('pipe', '/static/app01/images/pipe.png');
    game.load.image('background', '/static/app01/images/background.png');
    game.load.image('ground', '/static/app01/images/ground.png');
  },
